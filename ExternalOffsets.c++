// Roblox Version: version-2d6639b3364b47cd
// Byfron Version: HYPV4.4.2.0
// Dumped IDA 8.0
// Dumped By sfcjordon on discord using IDA 8.0
namespace offsets {
    ...
    inline constexpr uintptr_t CameraMaxZoomDistance = 0x49;
    inline constexpr uintptr_t CameraMinZoomDistance = 0x36;
    ...
    inline constexpr uintptr_t CharacterAppearanceId = 0x1E8;
    ...
    inline constexpr uintptr_t DataModelPrimitiveCount = 0x470;
    ...
    inline constexpr uintptr_t DataModelWeirdInstancesCount = 0x474;
    ...
    inline constexpr uintptr_t Dimensions = 0x730;
    inline constexpr uintptr_t DisplayName = 0x108;
    inline constexpr uintptr_t FOV = 0x140;
    inline constexpr uintptr_t FakeDataModelPointer = 0x5C80288;
    ...
    inline constexpr uintptr_t FramePositionOffsetX  = 0x36C;
    inline constexpr uintptr_t FramePositionOffsetY = 0x374;
    inline constexpr uintptr_t FramePositionX = 0x368;
    inline constexpr uintptr_t FramePositionY = 0x370;
    inline constexpr uintptr_t FrameRotation = 0x180;
    inline constexpr uintptr_t FrameSizeX = 0x110;
    inline constexpr uintptr_t FrameSizeY = 0x114;
    ...
    inline constexpr uintptr_t HumanoidState = 0x850;
    inline constexpr uintptr_t HumanoidStateId = 0x20;
    inline constexpr uintptr_t InputObject = 0xF8;
    inline constexpr uintptr_t Inset = 0x0;
    ...
    inline constexpr uintptr_t JobsPointer = 0x5D336B8;
    ...
    inline constexpr uintptr_t PlaceId = 0x170;
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x5C220F8;
    ...
    inline constexpr uintptr_t PrimitivesPointer2 = 0x1F8;
    inline constexpr uintptr_t ProximityPromptActionText = 0xC8;
    inline constexpr uintptr_t ProximityPromptEnabled = 0x13A;
    inline constexpr uintptr_t ProximityPromptGamepadKeyCode = 0x124;
    inline constexpr uintptr_t ProximityPromptHoldDuraction = 0x128;
    inline constexpr uintptr_t ProximityPromptMaxActivationDistance = 0x130;
    inline constexpr uintptr_t ProximityPromptMaxObjectText = 0xE8;
    inline constexpr uintptr_t RenderJobToDataModel = 0x198;
    ...
    inline constexpr uintptr_t TaskSchedulerPointer = 0x5D334E8;
    ...
    inline constexpr uintptr_t UserId = 0x1F8;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x5A92FD0;
    inline constexpr uintptr_t VisualEngineToDataModel1 = 0x710;
    ...
    inline constexpr uintptr_t viewmatrix = 0x4C0;
}
